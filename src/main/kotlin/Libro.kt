...
*/
data class Libro(val id:String?, val autor:String?, val anioPublicacion:String?, val tematica:String?, val estado:String = "Disponible") {
    ...
    init {
        ...
        require(!anioPublicacion.isNullOrBlank()){"El año de publicacion no puede ser nulo ni estar vacio"}
